...
const AddQuoteForm = () => {
    ...
    const [formEntries, setFormEntries] = useState([
        { id: Date.now(), movie: '', quote: '', year: '', timestamp: '', language: 'English' }
    ]);
    ...
    const addFormEntry = () => {
        setFormEntries([...formEntries, { id: Date.now(), movie: '', quote: '', year: '', timestamp: '', language: 'English' }]);
    };
    ...
    return (
        <div className="p-4">
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-5 items-center h-4 gap-2 text-center">
