...
const FormHandler = () => {
    ...
    return (
        <div className="lg:bg-white lg:shadow-[0px_0px_30px_10px] lg:shadow-[#00000010] lg:p-4 lg:flex lg:flex-row lg:min-w-[940px] rounded-xl lg:gap-[100px]">
                        ...
                        {navigationItems.map((nav, i) => {
                            ...
                            return (
                                <div key={nav} className="flex gap-4 items-center">
                                    <span
                                        className={`${realIndex == currentStep + 1 && "stepActive"
            ...
            <div
                className={` w-full lg:max-w-[450px] flex flex-col gap-5 ${finishedForm ? "pb-0" : "pb-10"
                    } lg:pb-0`}
            >
                <section
                    className={`lg:max-w-[450px] lg:w-full shadow-[0px_0px_30px_10px] shadow-[#00000011] lg:shadow-none bg-white py-[35px] px-6 rounded-xl mx-4 -translate-y-[74px] lg:py-0 lg:rounded-none lg:mx-0 lg:static lg:-translate-y-0 lg:px-0 ${finishedForm && "h-full py-20 lg:py-0"
                        }`}
                >
                    <FormDisplay />
                </section>
                {!finishedForm && (
                    <footer
                        className={`${currentStep >= 1 ? "justify-between" : "justify-end"
                            } lg:w-full  flex lg:shadow-none bg-white p-4 lg:p-0 shadow-[0px_0px_20px_10px] shadow-[rgba(0,0,0,0.05)]`}
                    >
                        {currentStep > 0 && (
                            <Button
